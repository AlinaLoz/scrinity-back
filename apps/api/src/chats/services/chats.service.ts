...
export class ChatsService extends LibChatService {
  constructor(
    ...
    super(connection, chatsRepository, guserRepository, gmanagerRepository, gmessageRepository, gnotificationService);
  }
    ...
    await this.connection.transaction(async (manager) => {
      ...
      const authType =
        typeof data.userId !== 'undefined'
          ? CHAT_AUTH_TYPE.byNumber
          : data?.email
          ? CHAT_AUTH_TYPE.byEmail
          : CHAT_AUTH_TYPE.anonymously;

...
export function ApiPropertyBoolean({ isOptional }: { isOptional?: boolean } = {}): <TFunction extends Function, Y>(
  ...
  return applyDecorators(
    ...
    Transform(({ value }) => {
      return !isNumberString(value) && (isBooleanString(value) || isBoolean(value))

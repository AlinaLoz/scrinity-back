...
DOCKER_APP_REPOSITORY=project-z-nginx
...
# Build Docker image
docker build -f "$(dirname "$0")/../../docker/nginx/Dockerfile" -t $DOCKER_APP_REPOSITORY:"$DOCKER_TIME_TAG" -t $DOCKER_APP_REPOSITORY:$DOCKER_LATEST_TAG "$(dirname "$0")/../../"
